...
class Eps extends BasePaymentMethod {
    ...
    public function get_payment_method_description(): string {
        $method_description = sprintf(
            __('EPS is a secure payment method and a popular choice for online consumers in Austria. <br />Read more about <a href="%s" target="_blank">%s</a> on MultiSafepay\'s Documentation Center.', 'multisafepay'),
