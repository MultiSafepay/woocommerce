...
use MultiSafepay\WooCommerce\PaymentMethods\PaymentMethods\PayAfterDeliveryInstallments;
...
class Gateways {
    ...
    const GATEWAYS = array(
        ...
        'multisafepay_payafterdelivery_installments' => PayAfterDeliveryInstallments::class,
