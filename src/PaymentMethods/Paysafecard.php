...
class Paysafecard extends BasePaymentMethod {
    ...
    public function get_payment_method_description(): string {
        $method_description = sprintf(
            __('Allow customers to pay for purchases without providing any sensitive financial information. <br />Read more about <a href="%s" target="_blank">%s</a> on MultiSafepay\'s Documentation Center.', 'multisafepay'),
