...
class Visa extends BasePaymentMethod {
    ...
    public function get_payment_method_description(): string {
        $method_description = sprintf(
            __('Increase conversions by accepting Visa payments with a worldwide reach. <br />Read more about <a href="%s" target="_blank">%s</a> on MultiSafepay\'s Documentation Center.', 'multisafepay'),
