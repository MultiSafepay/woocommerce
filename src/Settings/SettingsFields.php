    ...
    private function get_settings_options(): array {
        return array(
            ...
            'fields'		        => array(
                ...
                array(
                    'id' 			=> $this->plugin_name . '_giftcards_enabled',
                    'label'			=> __( 'Enable Giftcards' , $this->plugin_name ),
                    'description'	=> '',
                    'type'			=> 'select',
                    'options'		=> array(
                        'no' =>  __('Disable', $this->plugin_name),
                    ...
                    'default'		=> 'no',
                    'placeholder'	=> __( 'Enable Giftcards', $this->plugin_name ),
                    'tooltip'       => '',
                    'callback'      => '',
                    'setting_type'  => 'string',
                    'sort_order'    => 5,
                ...
                array(
                    'id' 			=> $this->plugin_name . '_show_images',
                    'label'			=> __( 'Show Payment Logos' , $this->plugin_name ),
                    'description'	=> __('Show gateway logos during checkout.', $this->plugin_name),
                    'type'			=> 'select',
                    'options'		=> array(
                        'no'  =>  __('Disable', $this->plugin_name),
                        'yes' => __('Enable', $this->plugin_name),
