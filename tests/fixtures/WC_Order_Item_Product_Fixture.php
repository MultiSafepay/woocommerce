...
class WC_Order_Item_Product_Fixture extends WP_UnitTestCase {
     ...
     */
    public function __construct(int $product_id, string $product_name,  float $product_price, int $product_quantity, float $product_tax_rate, int $discount_percentage ) {
    ...
    public function get_wc_order_item_product_mock() {
        ...
        $wc_order_item_product =  $this->getMockBuilder( 'WC_Order_Item_Product' )
                                       ...
                                       ->setMethods( array( 'get_id', 'get_name', 'get_type', 'get_quantity', 'get_subtotal', 'get_total_tax', 'get_product_id', 'get_variation_id', 'get_tax_class', 'get_taxes', 'get_product' ) )
                                       ->getMock();
